...
import mu.KLogging
import org.discipl.flint.sources.test.clients.CsvNsxTextLineClient.CsvTextLine
...
class CsvTextLineTransformer : NewTextLineTransformer<CsvTextLine> {
    ...
    private fun CsvTextLine.isTitleLine(): Boolean {
        return this.textNodeType == "Title" && this.isTextLine() && this.structureCategory != "Lid"
    }
