...
internal class SourceServiceImplTest : KoinTest, TestWithTestExtension() {
    ...
    fun getSourceForBwb() {
        ...
        assertThat(sourceForBwb, hasProperty("bwbId", equalTo("BWBR0043324")))
        assertThat(
            sourceForBwb,
            hasProperty("name", equalTo("Beleidsregel tegemoetkoming ondernemers getroffen sectoren COVID-19"))
        )
