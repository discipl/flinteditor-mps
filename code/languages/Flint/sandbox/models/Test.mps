...
<model ref="r:6a404292-b01a-494e-ab06-c424caf266f6(Test)">
    ...
    <node concept="mu5$5" id="6u5qVtI13SW">
        <property role="TrG5h" value="afwijzen de minister beslist op een aanvraag Process Must Be Dead" />
        ...
        <node concept="1GVOM6" id="4gg1F7ZHQ94" role="1GVO30">
            <property role="1GVPtb" value="afwijzen de minister beslist op een aanvraag Process Must Be Dead" />
            <property role="1GVPtd" value="English" />
        </node>
    </node>
    ...
    <node concept="mu5$5" id="6u5qVtI13Tk">
        <property role="TrG5h" value="indienen een aanvraag Hello World 123" />
        <property role="3GE5qa" value="acts" />
        <property role="207Gpp" value="[indienen]" />
        ...
        <node concept="1GVOM6" id="4gg1F7ZHQ9q" role="1GVO30">
            <property role="1GVPtb" value="indienen een aanvraag Hello World 123" />
            <property role="1GVPtd" value="English" />
        </node>
    </node>
